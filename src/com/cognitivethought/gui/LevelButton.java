...
public class LevelButton {
	...
	public void addButton(int levelNum) { //method to set the different textures ad other properties of the button
		...
		switch (levelNum) { //based on the button number in the list it changes the texture of the buttons
			case (0):
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL1_POS : Resources.LVL1_NEG;
				break;
			case (1):
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL2_POS : Resources.LVL2_NEG;
				break;
			case (2):
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL3_POS : Resources.LVL3_NEG;
				break;
			case (3):
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL4_POS : Resources.LVL4_NEG;
				break;
			case (4):
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL5_POS : Resources.LVL5_NEG;
				break;
			default:
				texture = TreePlayer.levelsPassed <= levelNum ? Resources.LVL1_POS : Resources.LVL1_NEG;
				break;
